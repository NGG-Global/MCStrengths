/* @ds-bundle: {"format":3,"namespace":"MaccabiOfekDesignSystem_d5ec4c","components":[],"sourceHashes":{"presentation/deck-stage.js":"208980974db4","slides/deck-stage.js":"0c125b8b1e23","uploads/עדכון מצגת בעברית/ds-base.js":"9f1fa6235965"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.MaccabiOfekDesignSystem_d5ec4c = window.MaccabiOfekDesignSystem_d5ec4c || {});
...
// uploads/עדכון מצגת בעברית/ds-base.js
try { (() => {
...
(() => {
  const base = '_ds/delek-motors-design-system-8afe14a9-9e43-4057-ab72-a45acc3b3ba4';
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "uploads/עדכון מצגת בעברית/ds-base.js", error: String((e && e.message) || e) }); }
